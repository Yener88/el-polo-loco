const level1 = new Level(
    ...
    [
        ...
        new BackgroundObject('img/backgroundobjects/dessert3/1.png', 0),
        new BackgroundObject('img/backgroundobjects/dessert3/2.png', 960),
        new BackgroundObject('img/backgroundobjects/dessert3/1.png', 1920),
        new BackgroundObject('img/backgroundobjects/dessert3/2.png', 2880),
        new BackgroundObject('img/backgroundobjects/dessert2/1.png', 0),
        new BackgroundObject('img/backgroundobjects/dessert2/2.png', 960),
        new BackgroundObject('img/backgroundobjects/dessert2/1.png', 1920),
        new BackgroundObject('img/backgroundobjects/dessert2/2.png', 2880),
        new BackgroundObject('img/backgroundobjects/dessert1/1.png', 0),
        new BackgroundObject('img/backgroundobjects/dessert1/2.png', 960),
        new BackgroundObject('img/backgroundobjects/dessert1/1.png', 1920),
        new BackgroundObject('img/backgroundobjects/dessert1/2.png', 2880),
    ],
    [
